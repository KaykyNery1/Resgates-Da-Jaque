            ...
            <div className="fade-on-scroll">
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Mais de 160 animais dependem totalmente dos nossos cuidados, com gastos mensais acima de <strong className="text-blue-600">R$16.000. Sua doação garante tratamento, alimento e a chance de um recomeço digno. Com sua ajuda, transformamos sofrimento em esperança.
                  </p>
                  <p>
